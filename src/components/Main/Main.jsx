...
const Main = () => {
    ...
    const addTask = (e) => {
        ...
        if(newTask.name.length===0 || newTask.namber.length===0) {
            alert("Iltimos ro'hatni to'liq to'ldiring!!!")
        } else {
                ...
                <div className="shadow p-5 mt-5 w-75 mx-auto">
                    <form className='form' onSubmit={(e)=>addTask(e)}>
                        ...
                        <label htmlFor="task_phone" className='w-50 d-block mx-auto mb-4'>
                            ...
                            <input type="number" id='task_userphone' className='form-control p-1 w-100' value={ namber } onChange={(e)=>setPhone(e.target.value)}/>
                        </label>
                        ...
                        <tbody className='bodys'>
                          {
                            task?.map((item,index)=>{
                                ...
                                <div className='btn-wrap'>
                                    ...
                                    <button className='btn-delete d-block'><img src={imgsss} /></button>
                                </div>
...
{/* <div className='table_wrap'>
                        <div className='table-wrap-item'>
                           ...
                           <p className='fw-bold text-uppercase'>added time</p>
                           </div>
                   ...
                   <div className='user-wrap'>
                    <img src={imgs} alt="" width={30} height={30}/>
                    <div className='boxs'>
                       <div className='user-wrap-item'>
                    <p>loremawdawd</p>
                    <p>loremawdawd</p>
                    <div className='user-item'><p>loremawdadwa</p></div>
